...
class Pintlabs_Service_Brewerydb
{
     ...
     * @var string
     */
    protected $_apiKey = '06951411bd14386887542fd142d7c8d1';

    protected $_url = 'http://richardupdegrove.me/beer_app/';
  ...
  $bdb = new Pintlabs_Service_Brewerydb('06951411bd14386887542fd142d7c8d1');
  $bdb->setFormat('json');

  //$results = $bdb->request('/beers');
  ...
  try {
    ...
    // $results = $bdb->request( '/search', $searchParams, 'GET'); // where $params is a keyed array of parameters to send with the API call.
    // echo json_encode($results);
    // echo json_encode($_POST); 
    // echo json_encode($_GET); 
